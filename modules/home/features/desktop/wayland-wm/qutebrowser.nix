# qutebrowser themed from the colorscheme. firefox stays the default browser
# (mimeApps live there); persistence covers bookmarks/greasemonkey/history.
{
  flake.homeModules.homeQutebrowser = {
    config,
    pkgs,
    lib,
    ...
