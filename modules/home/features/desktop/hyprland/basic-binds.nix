# Core hyprland keybinds: window/workspace management, focus movement,
# groups, monitors. App launchers live in the main hyprland module.
{
  flake.homeModules.homeHyprlandBinds = {lib, ...}: {
