# Replacement for home-manager's services/pass-secret-service.nix with
# extraArgs support (uses the patched native pass-secret-service package).
{
  flake.homeModules.homePassSecretService = {
    pkgs,
    config,
    lib,
    ...
