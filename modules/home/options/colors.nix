# Colorscheme options, generated from a wallpaper or base color via the
# `themes` flake input (exposed as pkgs.inputs.themes by the flake-inputs
# overlay).
{
  flake.homeModules.homeColors = {
    lib,
    config,
    pkgs,
    ...
